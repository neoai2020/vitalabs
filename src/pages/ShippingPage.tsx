        ...
        <div className="legal-container">
          ...
          <section>
            ...
            <ol>
              ...
              <li>Contact us at <a href="mailto:support@peptiva.co.uk">support@peptiva.co.uk</a> with your order number</li>
            </ol>
          ...
          <section>
            <h2>8. Contact</h2>
            <p>For shipping enquiries, contact <a href="mailto:support@peptiva.co.uk">support@peptiva.co.uk</a>.</p>
          </section>
        </div>
      </main>
      <SiteFooter />
